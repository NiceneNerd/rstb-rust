...
#[repr(C)]
pub struct SafeString { ptr: u64, v: [u8; 8] }
impl IParamType for SafeString {}

#[repr(C)]
pub struct FixedSafeString32 { ptr: u64, v: [u8; 32] }
impl IParamType for FixedSafeString32 {}

#[repr(C)]
pub struct FixedSafeString64 { ptr: u64, v: [u8; 64] }
impl IParamType for FixedSafeString64 {}

#[repr(C)]
pub struct FixedSafeString256 { ptr: u64, v: [u8; 256] }
